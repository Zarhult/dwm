...
*/
    ...
    /* my keybinds */
    { MODKEY,                       XK_bracketleft,     spawn,          {.v = voldwncmd } }, 
    { MODKEY,                       XK_bracketright,    spawn,          {.v = volupcmd } }, 
    { MODKEY,                       XK_backslash,       spawn,          {.v = volmutecmd } }, 
    { MODKEY|ShiftMask,             XK_bracketleft,     spawn,          {.v = brtdwncmd } }, 
    { MODKEY|ShiftMask,             XK_bracketright,    spawn,          {.v = brtupcmd } }, 
    { MODKEY,                       XK_n,               spawn,          {.v = nnncmd } }, 
    { MODKEY,                       XK_r,               spawn,          {.v = ncmpcppcmd } }, 
    { MODKEY,                       XK_slash,           spawn,          {.v = papecmd } }, 
    { MODKEY,                       XK_u,               spawn,          {.v = wpgcmd } }, 
